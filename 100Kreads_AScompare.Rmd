...
```{r, echo=FALSE}
ggplot(allRegionsCovered, aes(start, cov_sum,10))  + geom_point(aes(colour = par, shape = par), alpha = 0.7) + scale_color_manual(values = c("orange","green","blue", "magenta","darkgray")) + xlab("position") + ylab("coverage") + facet_wrap(~chr)
```
plot the log10 read coverage across all chromosome positions  
```{r, echo=FALSE}
ggplot(allRegionsCovered, aes(start, log(cov_sum,10)))  + geom_point(aes(colour = par, shape = par), alpha = 0.7) + scale_color_manual(values = c("orange","green","blue", "magenta","darkgray")) + xlab("position") + ylab("coverage") + facet_wrap(~chr)
```
